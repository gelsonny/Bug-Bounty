...
##GetJS##
getJS --input /home/kali/BugBounty/$1/$1-alive --complete > /home/kali/BugBounty/$1/getjs

##waybackurls##
cat /home/kali/BugBounty/$1/$1-alive | waybackurls > /home/kali/BugBounty/$1/waybackurl



sort /home/kali/BugBounty/$1/cariddi-$1.txt | uniq >> finalresults.txt
sort /home/kali/BugBounty/$1/getAllUrls-$1.txt | uniq >> finalresults.txt
sort /home/kali/BugBounty/$1/gospidy/* | uniq  >> finalresults.txt
sort /home/kali/BugBounty/$1/katana | uniq >> finalresult.txt
sort /home/kali/BugBounty/$1/waybackurl | uniq >> finalresult.txt

cat finalresult.txt | grep -Eo "(http|https)://[a-zA-Z0-9./?=_%:-]*" | sort -u > /home/kali/BugBounty/$1/final-output.txt
